...
exports.sendOrderStatusUpdate = exports.sendOrderConfirmation = exports.sendWelcomeEmail = exports.sendGiftCardEmail = exports.sendReturnRequestEmail = exports.sendFaqQuestionEmail = exports.sendContactFormEmail = void 0;
...
const sendFaqQuestionEmail = async (name, email, question) => {
    try {
        const info = await transporter.sendMail({
            from: '"MISAT Shop" <8888888gorni@gmail.com>',
            to: '8888888gorni@gmail.com',
...
exports.sendFaqQuestionEmail = sendFaqQuestionEmail;
// Отправка заявки на возврат
const sendReturnRequestEmail = async (orderNumber, productName, reason, comment) => {
    try {
        const info = await transporter.sendMail({
            from: '"MISAT Shop" <8888888gorni@gmail.com>',
            to: '8888888gorni@gmail.com',
...
exports.sendReturnRequestEmail = sendReturnRequestEmail;
// Отправка подарочного сертификата
const sendGiftCardEmail = async (recipientEmail, recipientName, code, amount, message, senderName) => {
    try {
        const info = await transporter.sendMail({
            from: '"MISAT Shop" <8888888gorni@gmail.com>',
            to: recipientEmail,
...
const sendOrderConfirmation = async (email, name, orderNumber, total) => {
    try {
        const info = await transporter.sendMail({
            from: '"MISAT Shop" <8888888gorni@gmail.com>',
            to: email,
...
const sendOrderStatusUpdate = async (email, name, orderNumber, status) => {
    const statusText = {
