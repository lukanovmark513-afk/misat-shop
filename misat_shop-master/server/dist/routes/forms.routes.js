...
router.post('/contact', async (req, res) => {
    try {
        ...
        await (0, emailService_1.sendContactFormEmail)(name, email, message);
...
router.post('/faq', async (req, res) => {
    try {
        ...
        await (0, emailService_1.sendFaqQuestionEmail)(name, email, question);
...
router.post('/return', async (req, res) => {
    try {
        ...
        await (0, emailService_1.sendReturnRequestEmail)(orderNumber, productName, reason, comment);
...
router.post('/send-gift-card', async (req, res) => {
    try {
        ...
        await (0, emailService_1.sendGiftCardEmail)(recipientEmail, recipientName, code, amount, message, senderName);
